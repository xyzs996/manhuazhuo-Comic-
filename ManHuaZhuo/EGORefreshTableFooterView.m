...
- (void)refreshLastUpdatedDate {
	...
	if ([_delegate respondsToSelector:@selector(egoRefreshTableHeaderDataSourceLastUpdated:)]) {
		...
		[formatter setAMSymbol:NSLocalizedString(@"上午", @"")];
		[formatter setPMSymbol:NSLocalizedString(@"下午", @"")];
...
- (void)setState:(EGOPullRefreshState)aState{
	...
	switch (aState) {
		case EGOOPullRefreshPulling:
			...
			_statusLabel.text = NSLocalizedString(@"松开可获取更多...", @"松开可获取更多...");
			[CATransaction begin];
		...
		case EGOOPullRefreshNormal:
			...
			_statusLabel.text = NSLocalizedString(@"上拉可获取更多...", @"上拉可获取更多...");
